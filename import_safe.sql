-- Safe import: Create tables in correct order
SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";
START TRANSACTION;
SET time_zone = "+00:00";

-- Create course_categories first
...
-- Create courses table last (with foreign keys)
CREATE TABLE IF NOT EXISTS `courses` (
  ...
  CONSTRAINT `fk_courses_level` FOREIGN KEY (`level_id`) REFERENCES `course_levels` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
