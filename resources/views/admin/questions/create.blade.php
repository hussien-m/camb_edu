                        ...
                        @foreach($oldOptions as $index => $option)
                            <div class="option-item mb-3" data-index="{{ $index }}">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control @error('options.'.$index.'.text') is-invalid @enderror" name="options[{{ $index }}][text]" placeholder="Enter option text" value="{{ $option['text'] ?? '' }}" required>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="correct_option" value="{{ $index }}" id="correct_{{ $index }}" {{ ($option['is_correct'] ?? false) ? 'checked' : '' }} required>
